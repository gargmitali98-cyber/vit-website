...
const app = express();
const JWT_SECRET = 'daman-uw-secret-2024';
...
// one route per step — merge partial data
...
// documents — accept both PUT and POST
...
app.post('/api/applications/:id/submit', (req, res) => {
  ...
  // Collect disease IDs from answers array OR legacy disclosures array
  const diseaseIds = (() => {
